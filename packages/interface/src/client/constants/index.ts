...
// used to ensure the user doesn't send so much WFGOLD so they end up with <.01
export const MIN_WDOGE: JSBI = JSBI.exponentiate(JSBI.BigInt(10), JSBI.BigInt(16)); // .01 WFGOLD
