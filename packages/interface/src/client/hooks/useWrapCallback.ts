            ...
            return {
                ...
                execute:
                    sufficientBalance && inputAmount
                        ? async () => {
                              try {
                                  ...
                                  addTransaction(txReceipt, {
                                      summary: `Wrap ${inputAmount.toSignificant(6)} WFGOLD to WWFGOLD`,
                                  });
                              } catch (error) {
                        ...
                        : undefined,
                inputError: sufficientBalance ? undefined : "Insufficient WFGOLD balance",
            };
                    ...
                    sufficientBalance && inputAmount
                        ? async () => {
                              try {
                                  ...
                                  addTransaction(txReceipt, {
                                      summary: `Unwrap ${inputAmount.toSignificant(6)} WWFGOLD to WFGOLD`,
                                  });
                              } catch (error) {
                        ...
                        : undefined,
                inputError: sufficientBalance ? undefined : "Insufficient WWFGOLD balance",
            };
        } else {
